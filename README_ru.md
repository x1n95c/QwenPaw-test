...
- [2026-05-14] Выпущена версия **v1.1.7**! Полное описание — в [примечаниях к выпуску v1.1.7](https://qwenpaw.agentscope.io/release-notes).
  ...
  - **[v1.1.7] Добавлено**: входящие (одобрения и push-сообщения); улучшения Cron (одноразовое выполнение, календарь, встроенные шаблоны, история выполнения и трассировка); Browser Use пакетные действия и загрузка файлов; OAuth 2.1 для удалённых MCP-серверов; управление плагинами в консоли; плагины Qwen-Image и Wan 2.7; асинхронное выполнение внешних агентов.
  - **[v1.1.7] Изменения**: селектор моделей переработан в поисковый плоский список; плавающая кнопка чата.
  - **[v1.1.7] Производительность**: оптимизация памяти при чтении файлов; защита от зависания Keyring.
  - **[v1.1.7] Исправлено**: маршрутизация истории сессий; ID моделей Volcengine; поддержание WebSocket Feishu.
  - **[v1.1.7] Новые участники**: @weixizi, @StarTrekking, @aqilaziz, @suntp.
